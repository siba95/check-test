...
<body>
	...
	<table class="re_table">
		...
		<tr>
			<th>作業内容</th>
			<td><textarea rows="4" cols="30" name="outline"  class="validate[required]" ><?php echo str_replace("<br />","&#13;",$outline);?></textarea>
				<div>
				<?php if($erroroutline)
				{
					echo "100文字以上は登録できません。";
				}?>
				</div>
			</td>
		</tr>
		...
		<tr>
			<th>備考</th>
			<td><textarea rows="4" cols="30" name="other"><?php echo str_replace("<br />","&#13;",$other);?></textarea>
				<div>
				<?php if($errorother)
				{
					echo "100文字以上は登録できません。";
